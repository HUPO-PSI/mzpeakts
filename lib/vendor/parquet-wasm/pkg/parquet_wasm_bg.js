...
function __wbg_adapter_8(arg0, arg1, arg2) {
    wasm.closure3807_externref_shim(arg0, arg1, arg2);
}
...
function __wbg_adapter_283(arg0, arg1, arg2, arg3) {
    wasm.closure3821_externref_shim(arg0, arg1, arg2, arg3);
}
...
export class ParquetMetaData {
     ...
     * @returns {any[]}
     */
    columnIndexFor(column) {
        const ret = wasm.parquetmetadata_columnIndexFor(this.__wbg_ptr, column);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
...
export function __wbindgen_cast_6204edb8b4271e8d(arg0, arg1) {
    // Cast intrinsic for `Closure(Closure { dtor_idx: 3796, function: Function { arguments: [Externref], shim_idx: 3807, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
    const ret = makeMutClosure(arg0, arg1, 3796, __wbg_adapter_8);
    return ret;
};
...
export function __wbindgen_cast_829978f7e672581b(arg0, arg1) {
    ...
    const ret = makeMutClosure(arg0, arg1, 337, __wbg_adapter_11);
    return ret;
};
